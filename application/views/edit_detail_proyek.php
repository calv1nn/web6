    ...
    <div class="main-inner">
        ...
        <div class="container">
         ...
         <div class="row">
            ...
            ?>
                <?php echo form_open("detail_proyek/edit_detail_proyek/".$kode_proyek."/".$id_pekerjaan); ?>
                            
                <div class="field">
                    <?php echo form_input(array('name' => 'id_pekerjaan', 'value' => '', 'type' => 'hidden' ));?>
                </div> <!-- /field -->
                
                <?php foreach ($edit_detail_proyek as $row)
                {
                ?>
               
                <div class="field">
                    <label for="kode_proyek">Nama proyek:</label>
                ...
                <?php echo form_dropdown('jenis_pekerjaan', $jenis_pekerjaan, $row['nama_pekerjaan']);?> 
                
                </div> <!-- /field -->
                
                <div class="field">
                    <label for="nik">Penanggung Jawab:</label>    
                <?php echo form_dropdown('nik123', $dropdown, $row['nik']);?> 
				...
				<table border="5" style="width:400px">
						...
						<tr>
							...
							?>
							<td>
							<?php echo form_checkbox('nik[]',$row2['nik'],$row2['check']);  ?>
				...
				<br>
				 ...
				 <div class="field">
                    ...
                    <?php echo form_dropdown('jam', $jam, $row['jam']); ?>
                </div> <!-- /field -->
                
                <div class="field">
                    <label for="start_date">Start Date:</label>
                    <?php echo form_error('start_date'); ?>
                    <?php echo form_input("start_date",$row['start_date'],"class='datepicker-start'"); ?>
                ...
                <div class="field">
                    ...
                    <?php echo form_input("end_date",$row['end_date'],"class='datepicker-end'"); ?>
                </div> 
				
				<div class="field">
                    <label for="keterangan">Keterangan:</label>    
                    <?php echo form_error('keterangan'); ?>
                    <?php echo form_textarea("keterangan",$row['keterangan']); ?>
                </div> <!-- /field -->
